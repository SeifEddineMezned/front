            ...
            <div className="relative z-10 w-full max-w-md p-6 animate-fade-in">
                ...
                >
                    ...
                    <form className="relative z-10 space-y-6" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-mono text-cyan-400 uppercase tracking-widest ml-1">Clearance</label>
                            <input
                                type="password"
                        ...
                        {/* Action Button */}
                        <button
                            className="w-full bg-gradient-to-r from-cyan-600 to-cyan-400 text-white font-bold py-4 rounded-xl shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 uppercase tracking-widest mt-4"
                            type="submit"
                        >
                            {isLogin ? 'Establish Link' : 'Register Operator'}
                        </button> {/* Placeholder: supabase.auth.signInWithPassword */}
